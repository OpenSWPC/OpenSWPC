            ...
            do i = i0, i1
                ...
                do k = k0, k1
                    ...
                    if (zs(k) > bd(i, j, 0)) then
                        ...
                        !! ocean column
                        !!
                        !! The code treat the uppermost layer as ocean column
                        !! if P-wave velocity is finite and S-wave velocity is zero
                        ...
                        !! Please use non-zero but very small density (e.g., 0.001) for avoiding
                        !! zero division with satisfying boundary cond.
